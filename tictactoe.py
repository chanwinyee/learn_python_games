...
def isWinner(bo, le):
    # Given a board and a palyer's letter, this function returns True if that player has won.
    ...
    (bo[9] == le and bo[6] == le and bo[3] == le ) or # Diagonal
...
def getComputerMove(board, computerLetter):
    ...
    return chooseRandomMoveFromList(board, [1,2,6,8])
